...
pub trait HttpTransportJob {
    ...
    fn generate_filenames(schema: &str, num_threads: usize, addr_receiver: &Receiver<String>) -> Result<String> {
    ...
    #[inline]
    fn recv_address(schema: &str, receiver: &Receiver<String>, index: usize) -> TransportResult<String> {
        let addr = receiver
            .recv()
